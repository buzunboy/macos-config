...
mkdir -p ~/Desktop/Screenshots/macOS
...
defaults write com.apple.screencapture location -string ~/Desktop/Screenshots/macOS
...
mkdir -p ~/Desktop/Screenshots/Simulator
